...
**Related:** [`capacity_and_timing_math.md`](../capacity_and_timing_math.md), [`railway_5_service_roadmap.md`](railway_5_service_roadmap.md)
...
¹ Resolve can run on **S1** during scan (CPU only) or a one-shot **S5** job before supervisors flip fully to submit — no extra service cost if scripted.
...
| Date | Change |
|------|--------|
| 2026-09-10 | Initial report: §1 baseline, §2 free multi-service + supervisor, §3 paid 9-worker fleet |
